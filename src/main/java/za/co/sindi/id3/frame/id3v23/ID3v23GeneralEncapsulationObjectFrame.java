 ...
 *
 */
public class ID3v23GeneralEncapsulationObjectFrame extends ID3v23Frame implements ID3v2GeneralEncapsulationObjectFrame {
	 ...
	 * @param id
	 */
	public ID3v23GeneralEncapsulationObjectFrame(String id) {
		super(id);
