 ...
 *
 */
public class ID3v24UserDefinedURIFrame extends ID3v24Frame implements ID3v2DescriptiveInformationFrame<URI> {

	private static final Logger logger = Logger.getLogger(ID3v24UserDefinedURIFrame.class);
	 ...
	 * @param id
	 */
	public ID3v24UserDefinedURIFrame(String id) {
		super(id);
