 ...
 *
 */
public class ID3v23URIFrame extends ID3v23Frame implements	ID3v2InformationFrame<URI> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4854832318163659240L;
	private static final Logger logger = Logger.getLogger(ID3v23URIFrame.class);
	private String url;
	
	/**
	 * @param id
	 */
	public ID3v23URIFrame(String id) {
		super(id);
