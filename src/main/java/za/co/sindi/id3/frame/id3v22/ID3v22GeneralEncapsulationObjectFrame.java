 ...
 *
 */
public class ID3v22GeneralEncapsulationObjectFrame extends ID3v22Frame implements ID3v2GeneralEncapsulationObjectFrame {
	 ...
	 * @param id
	 */
	public ID3v22GeneralEncapsulationObjectFrame(String id) {
		super(id);
