 ...
 *
 */
public class ID3v22PictureFrame extends ID3v22Frame implements ID3v2PictureFrame {
	 ...
	 * @param id
	 */
	public ID3v22PictureFrame(String id) {
		super(id);
	...
	public void decodeFrameData(byte[] data) throws ID3Exception {
		...
		try {
			...
			mimeType = getMimeType(new String(b));
			
			//Picture Type
			pictureType = data[4] & 0xFF;
			
			//Description
			int startPosDesc = 5;
			int nullPos = startPosDesc;
