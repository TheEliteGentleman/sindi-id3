 ...
 *
 */
public class ID3v24URIFrame extends ID3v24Frame implements	ID3v2InformationFrame<URI> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4854832318163659240L;
	private static final Logger logger = Logger.getLogger(ID3v24URIFrame.class);
	private String url;
	
	/**
	 * @param id
	 */
	public ID3v24URIFrame(String id) {
		super(id);
