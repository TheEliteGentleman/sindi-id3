 ...
 *
 */
public class ID3v24UserDefinedTextFrame extends ID3v24Frame implements ID3v2DescriptiveInformationFrame<String> {
	 ...
	 * @param id
	 */
	public ID3v24UserDefinedTextFrame(String id) {
		super(id);
