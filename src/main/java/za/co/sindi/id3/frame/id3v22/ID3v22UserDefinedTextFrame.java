 ...
 *
 */
public class ID3v22UserDefinedTextFrame extends ID3v22Frame implements ID3v2DescriptiveInformationFrame<String> {
	 ...
	 * @param id
	 */
	public ID3v22UserDefinedTextFrame(String id) {
		super(id);
